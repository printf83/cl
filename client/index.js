...
import example from "../src/js/base/example.js";
import * as table from "../src/js/base/table.js";
import * as navbar from "../src/js/base/navbar.js";
import menu from "../src/js/base/menu.js";
import toc from "../src/js/base/toc.js";
import msg from "../src/js/base/msg.js";

import doc_intro from "../src/js/doc/intro.js";

import doc_container from "../src/js/doc/container.js";
import doc_grid from "../src/js/doc/grid.js";
import doc_column from "../src/js/doc/column.js";
import doc_gutter from "../src/js/doc/gutter.js";

import doc_formcontrol from "../src/js/doc/formcontrol.js";
import doc_select from "../src/js/doc/select.js";
import doc_checkradio from "../src/js/doc/checkradio.js";
import doc_range from "../src/js/doc/range.js";
import doc_inputgroup from "../src/js/doc/inputgroup.js";
import doc_floatinglabel from "../src/js/doc/floatinglabel.js";

import * as sample from "../src/js/doc/sample.js";
import doc_button from "../src/js/doc/button.js";
import doc_accordion from "../src/js/doc/accordion.js";
import doc_alert from "../src/js/doc/alert.js";
import doc_badge from "../src/js/doc/badge.js";
import doc_breadcrumb from "../src/js/doc/breadcrumb.js";
import doc_btngroup from "../src/js/doc/btngroup.js";
import doc_card from "../src/js/doc/card.js";
import doc_carousel from "../src/js/doc/carousel.js";
import doc_btnclose from "../src/js/doc/btnclose.js";
import doc_collapse from "../src/js/doc/collapse.js";
import doc_dropdown from "../src/js/doc/dropdown.js";
import doc_listgroup from "../src/js/doc/listgroup.js";
import doc_modal from "../src/js/doc/modal.js";
import doc_tab from "../src/js/doc/tab.js";
import doc_navbar from "../src/js/doc/navbar.js";
import doc_offcanvas from "../src/js/doc/offcanvas.js";
import doc_paging from "../src/js/doc/paging.js";
import doc_popover from "../src/js/doc/popover.js";
import doc_progress from "../src/js/doc/progress.js";
import doc_toast from "../src/js/doc/toast.js";
import doc_tooltip from "../src/js/doc/tooltip.js";

import doc_icon from "../src/js/doc/icon.js";
import doc_menu from "../src/js/doc/menu.js";
import doc_toc from "../src/js/doc/toc.js";
import doc_pill from "../src/js/doc/pill.js";
import doc_example from "../src/js/doc/example.js";
import doc_label from "../src/js/doc/label.js";
import doc_msg from "../src/js/doc/msg.js";
import doc_table from "../src/js/doc/table.js";

import doc_tag_base from "../src/js/doc/tag.base.js";
import doc_tag_text from "../src/js/doc/tag.text.js";
import doc_tag_background from "../src/js/doc/tag.background.js";
import doc_tag_border from "../src/js/doc/tag.border.js";
import doc_tag_color from "../src/js/doc/tag.color.js";
import doc_tag_display from "../src/js/doc/tag.display.js";
import doc_tag_flex from "../src/js/doc/tag.flex.js";
import doc_tag_float from "../src/js/doc/tag.float.js";
import doc_tag_interaction from "../src/js/doc/tag.interaction.js";
import doc_tag_overflow from "../src/js/doc/tag.overflow.js";
import doc_tag_position from "../src/js/doc/tag.position.js";
import doc_tag_shadow from "../src/js/doc/tag.shadow.js";
import doc_tag_size from "../src/js/doc/tag.size.js";
import doc_tag_spacing from "../src/js/doc/tag.spacing.js";
import doc_tag_valign from "../src/js/doc/tag.valign.js";
import doc_tag_visibility from "../src/js/doc/tag.visibility.js";

import doc_tag_ex_a from "../src/js/doc/tag.ex.a.js";
import doc_tag_ex_b from "../src/js/doc/tag.ex.b.js";
import doc_tag_ex_code from "../src/js/doc/tag.ex.code.js";
import doc_tag_ex_div from "../src/js/doc/tag.ex.div.js";
import doc_tag_ex_form from "../src/js/doc/tag.ex.form.js";
import doc_tag_ex_h from "../src/js/doc/tag.ex.h.js";
import doc_tag_ex_hr from "../src/js/doc/tag.ex.hr.js";
import doc_tag_ex_img from "../src/js/doc/tag.ex.img.js";
import doc_tag_ex_li from "../src/js/doc/tag.ex.li.js";
import doc_tag_ex_nav from "../src/js/doc/tag.ex.nav.js";
import doc_tag_ex_ol from "../src/js/doc/tag.ex.ol.js";
import doc_tag_ex_p from "../src/js/doc/tag.ex.p.js";
import doc_tag_ex_pre from "../src/js/doc/tag.ex.pre.js";
import doc_tag_ex_small from "../src/js/doc/tag.ex.small.js";
import doc_tag_ex_span from "../src/js/doc/tag.ex.span.js";
import doc_tag_ex_strong from "../src/js/doc/tag.ex.strong.js";
import doc_tag_ex_ul from "../src/js/doc/tag.ex.ul.js";
