...
export default [
...

	{
		...
		sample: { fnDiv: fnDiv },
		code: function () {
			return fnDiv("container", "Content here");
		},
	},

	{
		...
		code: function () {
			return [
				fnDiv("container-sm", "100% wide until small breakpoint"),
				fnDiv("container-md", "100% wide until medium breakpoint"),
				fnDiv("container-lg", "100% wide until large breakpoint"),
				fnDiv("container-xl", "100% wide until extra large breakpoint"),
				fnDiv("container-xxl", "100% wide until extra extra large breakpoint"),
			];
		},
	},

	{
		...
		sample: { fnDiv: fnDiv },
		code: function () {
			return fnDiv("container-fluid", "Content here");
		},
	},
];
